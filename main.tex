...
\author{
Alistair Johnson\textsuperscript{1{†}}
, Tom J. Pollard\textsuperscript{1{†}{*}}
, Lu Shen\textsuperscript{2}, \\
 Li-wei Lilehman\textsuperscript{1}
, Mornin Feng\textsuperscript{1} 
, Mohammad Ghassemi\textsuperscript{1}, \\
 Benjamin Moody\textsuperscript{1}
, Leo A. Celi\textsuperscript{1}
, Roger G. Mark\textsuperscript{1}
}

\maketitle
\thispagestyle{fancy}

1. MIT Institute for Medical Engineering and Science, Massachusetts Institute of Technology, Cambridge, Massachusetts, United States 2. Beth Israel Deaconess Medical Center, Boston, MA, United States. \\ 
...
Here we report release of the MIMIC-III database, an update to the widely-used MIMIC-II database \cite{cite3}. MIMIC-III integrates deidentified, comprehensive clinical data and makes it widely accessible to researchers internationally (Figure \ref{fig:mimicoverview}). The publicly available nature of the data allows clinical studies to be reproduced and improved in ways that would not otherwise be possible.
...
\begin{itemize}
  ...
  \item access is unrestricted once a data user agreement is accepted, enabling clinical research and education around the world.
\end{itemize}
...
The repository has been seeded with code to calculate commonly utilised concepts in critical care research, including severity of illness scores, comorbidity scores, and durations of mechanical ventilation.
% More detail regarding the concepts derived in the repository is available \cite{?}.
We encourage users to incorporate this code into their research, provide improvements, and make new contributions that would benefit the research community as a whole. Over time, we expect the repository to become increasingly vital for researchers working with the MIMIC-III database.
...
\begin{tabular}{|p{1.8cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|}
    ...
    \hline
    Age, years, median (Q1-Q3) & 70.1 (58.4-80.5) & 67.6 (57.6-76.7) & 64.9 (51.7-78.2) & 0.0 (0.0-0.0) & 63.6 (51.4-76.5) & 59.8 (42.8-75.6) & 62.0 (44.3-76.1) \\
    \hline
    Gender, male, \% of unit stays & 4,203 (57.9\%) & 6,001 (65.5\%) & 10,193 (51.6\%) & 4,310 (53.9\%) & 4,251 (52.4\%) & 3,340 (60.7\%) & 32,298 (55.9\%) \\
    \hline
    ICU length of stay, median days (Q1-Q3) & 2.2 (1.2-4.1) & 2.1 (1.2-4.0) &  2.1 (1.2-4.1) & 0.8 (0.1-9.7) & 2.3 (1.3-4.9) & 2.1 (1.2-4.6) & 2.1 (1.1-4.5) \\
    \hline
    Hospital length of stay, median days (Q1-Q3) & 5.8 (3.1-10.0) & 7.4 (5.2-11.4) & 6.4 (3.7-11.7) & 4.1 (2.3-10.3) & 7.9 (4.4-14.2) & 7.4 (4.1-13.6) & 6.6 (3.8-11.9) \\
    \hline
...
\begin{tabular}{|p{4.0cm}|p{1.25cm}|p{1.25cm}|p{1.25cm}|p{1.25cm}|p{1.25cm}|p{1.25cm}|}
    ...
    \hline
\end{tabular}
\caption{Distribution of primary International Classification of Diseases, 9th Edition (ICD-9) codes by first critical care unit on hospital admission for patients aged 16 years and older. CCU is Coronary Care Unit; CSRU is Cardiac Surgery Recovery Unit; MICU is Medical Intensive Care Unit; SICU is Surgical Intensive Care Unit; TSICU is Trauma Surgical Intensive Care Unit.}
