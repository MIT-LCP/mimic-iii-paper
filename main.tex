...
The five most common International Classification of Diseases, 9th Edition (ICD-9) codes across hospital admissions for adult patients (>=16 years on admission) were: 414.01 ("Coronary atherosclerosis of native coronary artery", 6.9\% of all hospital admissions); 038.9 ("Unspecified septicemia", 4.2\% of all hospital admissions), and 410.71 ("Subendocardial infarction, initial episode of care", 3.6\% of all hospital admissions). Table \ref{table:icddistribution} gives a more detailed indication of how the occurrence of diagnosed diseases, as indicated by the primary ICD-9 code, are distributed across the critical care units. 
...
\begin{center}
\begin{table}
\begin{tabular}{|p{4.0cm}|p{1.3cm}|p{1.3cm}|p{1.3cm}|p{1.3cm}|p{1.3cm}|p{1.3cm}|}
    \hline
    Critical care unit & 
