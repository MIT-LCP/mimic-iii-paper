...
\caption{Sample data for a patient over a single stay in a medical intensive care unit. GCS is Glasgow Coma Scale; BP is blood pressure; O2 Sat. is Oxygen saturation; and Resp. is respiratory rate.}
\end{figure}
