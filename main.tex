...
\begin{tabular}{|p{2.4cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|}
    ...
    \hline
    Distinct ICU stays, no. (\% of total admissions) & 7,726 (14.5\%) & 9,854 (18.4\%) & 21,087 (39.5\%) & 8,891 (16.6\%) & 5,865 (11.0\%) & 61,532 (100\%) \\
    \hline
