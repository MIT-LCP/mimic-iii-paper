...
Leo Anthony Celi\textsuperscript{1},
...
1. MIT Institute for Medical Engineering and Science, Massachusetts Institute of Technology, Cambridge, MA, United States 2. Beth Israel Deaconess Medical Center, Boston, MA, United States. \\ 
\\
...
MIMIC-III contains data associated with 53,423 distinct admissions for adult patients (aged 16 years or above) admitted to critical care units of the Beth Israel Deaconess Medical Center in Boston, Massachusetts, between 2001 and 2012. In addition, it contains data for 7870 neonates admitted between 2001 and 2008. The data covers 38,597 distinct adult patients over 49,785 hospital admissions. The median age of adult patients is 65.8 years (Q1-Q3: 52.8 - 77.8), 55.9\% patients are male, and in-hospital mortality is 11.5\%. Median length of ICU stay is 2.1 days (Q1-Q3: 1.2 - 4.6) and median length of hospital stay is 6.9 days (Q1-Q3: 4.1 - 11.9). A mean average of 4579 charted observations ('chart events') and 380 laboratory measurements ('lab events') are available for each hospital admission. Table \ref{table:patientpopulation} provides a breakdown of the adult population by care unit.
...
% MIMIC-III database. doi:10.13026/C2XW26
1. Johnson, AEW \& Pollard, TJ. The MIMIC III Clinical Database. \emph{PhysioNet} http://dx.doi.org/10.13026/C2XW26 (2015).
