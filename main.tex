...
\title{MIMIC-III, a public access database of critical medical care}
...
\label{figure:mimicoverview}
\end{figure}
\end{center}

\begin{center}
\begin{figure}
\includegraphics[width=\textwidth]{examplepatient.jpeg}
\caption{Sample data for a single patient stay in a medical intensive care unit. GCS is Glasgow Coma Scale; NIBP is non-invasive blood pressure; and O2 saturation is Oxygen saturation.}
\label{figure:examplepatient}
\end{figure}
\end{center}
...
% TP: response to reviewers. Move table so that it appears in correct order.
