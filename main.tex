...
The five most common International Classification of Diseases, 9th Edition (ICD-9) codes across hospital admissions were: 414.01 ('Coronary atherosclerosis of native coronary artery', 7.1\% of all admissions); 038.9 ('Unspecified septicemia', 4.2\% of all admissions), and 410.71 ('Subendocardial infarction, initial episode of care', 3.6\% of all admissions). Table \ref{table:icddistribution} gives an indication of how the occurrence of diagnosed diseases, as indicated by the primary ICD-9 code, are distributed across the critical care units. 
...
\begin{tabular}{|p{1.8cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|}
    ...
    \hline
    Hospital admissions, no. (\% of total admissions) & 7,258 (12.6\%) & 9,157 (15.8\%) & 19,771 (34.2\%) & 7,992 (13.8\%) & 8,110 (14.0\%) & 5,498 (9.5\%) & N(N\%) \\ 
    \hline
    Distinct ICU stays, no. (\% of total admissions) & 7,726 (12.6\%) & 9,855 (16.0\%) & 21,088 (34.3\%) & 8,100 (13.2\%) & 8,891 (14.4\%) & 5,872 (9.5\%) & N(N\%) \\ 
    \hline
    Age, years, median +- IQR & 70.1 (58.4-80.5) & 67.6 (57.6-76.7) & 64.9 (51.7-78.2) & 0.0 (0.0-0.0) & 63.6 (51.4-76.5) & 59.8 (42.8-75.6) & N(N\%) \\ 
    \hline
    Gender, male, \% of unit stays & 4,203 (57.9\%) & 6,001 (65.5\%) & 10,193 (51.6\%) & 4,310 (53.9\%) & 4,251 (52.4\%) & 3,340 (60.7\%) & N(N\%) \\ 
    \hline
    ICU length of stay, median days (IQR) & 2.2 (1.2-4.1) & 2.1 (1.2-4.0) &  2.1 (1.2-4.1) & 0.8 (0.1-9.7) & 2.3 (1.3-4.9) & 2.1 (1.2-4.6) & N(N\%) \\ 
    \hline
    Hospital length of stay, median days (IQR) & 5.8 (3.1-10.0) & 7.4 (5.2-11.4) & 6.4 (3.7-11.7) & 4.1 (2.3-10.3) & 7.9 (4.4-14.2) & 7.4 (4.1-13.6) & N(N\%) \\
    \hline
    ICU mortality, percent of unit stays & 685 (8.9\%) & 353 (3.6\%) & 2,222 (10.5\%) & 53 (0.7\%) & 813 (9.1\%) & 493 (8.4\%) & N(N\%) \\ 
    \hline
    Hospital mortality, percent of unit stays & 817 (11.3\%) & 424 (4.6\%) & 2,859 (14.5\%) & 64 (0.8\%) &  1,020 (12.6\%) & 629 (11.4\%) & N(N\%) \\ 
    \hline
\end{tabular}
...
\begin{tabular}{|p{3.8cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|}
    ...
    & 305 (4.3\%) & 72 (0.8\%) & 3,229 (16.7\%) & 1 (0.4\%) & 448 (5.6\%) & 152 (2.8\%) & N(N\%) \\ 
    \hline
    Neoplasms of digestive organs and intrathoracic organs, etc (140–239)
    & 126 (1.8\%) & 287 (3.2\%) & 1,415 (7.3\%) & 0 (0.0\%) & 1,225 (15.4\%) & 466 (8.6\%) & N(N\%) \\ 
    \hline
    Endocrine, nutritional, metabolic, and immunity (240–279) 
    & 104 (1.4\%) & 36 (0.4\%) & 986 (5.1\%) & 1 (0.4\%) & 178 (2.2\%) & 54 (1.0\%) & N(N\%) \\ 
    \hline
    ...
    & 5,131 (71.5\%) & 7,138 (78.7\%) & 2,638 (13.7\%) & 2 (0.7\%) & 2,356 (29.6\%) & 684 (12.6\%) & N(N\%) \\ 
    \hline
    Pulmonary diseases, ie, pneumonia and influenza, chronic obstructive pulmonary disease, etc. (460–519) 
    & 416 (5.8\%) & 141 (1.6\%) & 3,393 (17.6\%) & 1 (0.4\%) & 390 (4.9\%) & 225 (4.1\%) & N(N\%) \\ 
    \hline
    Diseases of the digestive system (520–579) 
    & 264 (3.7\%) & 157 (1.7\%) & 3,046 (15.8\%) & 1(0.4\%) & 1,193 (15.0\%) & 440 (8.1\%) & N(N\%) \\ 
    \hline
    ...
    & 130 (1.8\%) & 14 (0.2\%) & 738 (3.8\%) & 0 (0.0\%) & 101 (1.3\%) & 31 (0.6\%) & N(N\%) \\ 
    \hline
    Trauma (800–959) 
    & 97 (1.4\%) & 495 (5.5\%) & 480 (2.5\%) & 0 (0.0\%) & 836 (10.5\%) & 2,816 (51.9\%) & N(N\%) \\ 
    \hline
    Poisoning by drugs and biological substances (960–979) 
    & 47 (0.7\%) & 2 (0.0\%) & 538 (2.8\%) & 0 (0.0\%) & 56 (0.7\%) & 9 (0.2\%) & N(N\%) \\ 
    \hline
    Other & 556 (7.7\%) & 729 (8.0\%) & 2,844 (14.7\%) & 274 (97.8\%) & 1,178 (14.8\%) & 548 (10.1\%) & N(N\%) \\ 
    \hline
