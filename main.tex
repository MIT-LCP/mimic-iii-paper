...
MIMIC-III comprises data associated with approximately 46,520 patients admitted to critical care units of the Beth Israel Deaconess Medical Center in Boston, Massachusetts, between 2001 and 2012. The data covers approximately 57,786 unique hospital admissions and 61,532 unique stays in a critical care unit. Across all care units, the median age is 62.0 years (IQR: 44.3 - 76.1); 55.9\% patients are male; and in-hospital mortality is 10.1\%. Median length of ICU stay is 2.1 days, and median length of hospital stay is 6.6 days. Table \ref{table:patientpopulation}) provides a breakdown of the population by care unit.

The five most common International Classification of Diseases, 9th Edition (ICD-9) codes across hospital admissions for adult patients (>=16 years on admission) were: 414.01 ("Coronary atherosclerosis of native coronary artery", 6.9\% of all hospital admissions); 038.9 ("Unspecified septicemia", 4.2\% of all hospital admissions), and 410.71 ("Subendocardial infarction, initial episode of care", 3.6\% of all hospital admissions). Table \ref{table:icddistribution} gives a more in-depth indication of disease distribution across critical care units, as indicated by the primary ICD-9 code.
