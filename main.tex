...
Documentation for the MIMIC database is available online (http://mimic.physionet.org). The content is under continuous development and the website includes functionality that enables the research community to directly submit updates and improvements via Github "Pull requests".
...
AEWJ, TJP, and LS built the MIMIC-III database. LS and LW carried out de-identification. All authors gave feedback during the database development process and contributed to writing the paper. 
...
\bibitem{cite8}
\newblock \bibinfo{title}{{Observational Medical Outcomes Partnership - Common Data Model.}}
\newblock \emph{\bibinfo{journal}{Website}}
