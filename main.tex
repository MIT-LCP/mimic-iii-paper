...
\caption{Sample data for a single patient stay in a medical intensive care unit. GCS is Glasgow Coma Scale; BP is blood pressure; O2 Sat. is Oxygen saturation; and Resp. rate is respiratory rate.}
\end{figure}
